    ...
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 sm:px-12 md:px-16 py-36 sm:py-48 md:py-56 relative z-10">
        <div className="text-center max-w-2xl mx-auto w-full">
          ...
          <p className="text-2xl sm:text-2xl md:text-3xl text-gray-800/60 font-light tracking-wide mb-2">
            Silly Big Personality Test
          </p>
          <p className="text-lg sm:text-lg md:text-xl text-gray-700/30 mb-16 sm:mb-20 md:mb-24 tracking-wider">
            傻乎乎的大人格测试
          </p>

          <p className="text-xl sm:text-xl md:text-2xl text-gray-700/50 leading-[2.0] mb-20 sm:mb-24 md:mb-28" style={{ letterSpacing: '0.01em' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center max-w-xs sm:max-w-none mx-auto">
            <button
              onClick={onStartQuiz}
          ...
          {/* 数字指标 — 液态玻璃胶囊 */}
          <div className="mt-20 sm:mt-24 md:mt-28 flex justify-center gap-6 sm:gap-8 md:gap-12">
            <div className="px-8 py-6 sm:px-10 md:px-14 sm:py-7 md:py-9 text-center">
              <div className="text-4xl sm:text-4xl md:text-5xl font-bold text-purple-500" style={{ letterSpacing: '-0.03em' }}>27</div>
              <div className="text-sm sm:text-sm md:text-base text-gray-700/30 mt-2" style={{ letterSpacing: '0.04em' }}>种人格</div>
            </div>
            <div className="px-8 py-6 sm:px-10 md:px-14 sm:py-7 md:py-9 text-center">
              <div className="text-4xl sm:text-4xl md:text-5xl font-bold text-pink-500" style={{ letterSpacing: '-0.03em' }}>31</div>
              <div className="text-sm sm:text-sm md:text-base text-gray-700/30 mt-2" style={{ letterSpacing: '0.04em' }}>道题目</div>
            </div>
            <div className="px-8 py-6 sm:px-10 md:px-14 sm:py-7 md:py-9 text-center">
              <div className="text-4xl sm:text-4xl md:text-5xl font-bold text-blue-500" style={{ letterSpacing: '-0.03em' }}>15</div>
              <div className="text-sm sm:text-sm md:text-base text-gray-700/30 mt-2" style={{ letterSpacing: '0.04em' }}>个维度</div>
            </div>
          </div>

          {/* 快捷入口链接 */}
          <div className="mt-16 sm:mt-20 flex justify-center gap-8 text-sm text-gray-700/25">
      ...
      <div className="px-8 sm:px-12 md:px-16 pb-36 sm:pb-44 md:pb-52 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h3 className="text-3xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-4" style={{ letterSpacing: '-0.03em' }}>隐藏人格</h3>
          <p className="text-base sm:text-base text-gray-700/30 mb-14 sm:mb-16" style={{ letterSpacing: '0.01em' }}>有些人格，不是你想当就能当的</p>
            ...
            {specialPersonalities.map((sp, idx) => (
              <div key={sp.id} className="text-center animate-card-enter" style={{ animationDelay: `${idx * 0.1}s` }}>
                <div className="relative z-10">
                  ...
                  />
                  <div className="text-base sm:text-lg font-bold mb-2" style={{ color: sp.color, letterSpacing: '-0.01em' }}>{sp.name}</div>
                  <div className="text-xs sm:text-sm font-mono text-gray-700/20 mb-4" style={{ letterSpacing: '0.04em' }}>{sp.code}</div>
            ...
            <div className="relative z-10 grid grid-cols-3 gap-4 sm:gap-6">
              {randomPersonalities.map((p, idx) => (
                <div key={p.id} className="text-center py-5 animate-card-enter" style={{ animationDelay: `${idx * 0.05 + 0.2}s` }}>
                  ...
                  <div className="text-xs text-gray-700/20 mt-1.5" style={{ letterSpacing: '0.04em' }}>{p.code}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* CTA — 液态玻璃号召 */}
      <div className="px-8 sm:px-12 md:px-16 py-36 sm:py-48 md:py-56 text-center relative z-10">
        <h3 className="text-4xl sm:text-4xl md:text-5xl font-bold gradient-text animate-shimmer mb-8 md:mb-10" style={{ letterSpacing: '-0.03em' }}>准备好了吗？</h3>
        <p className="text-lg sm:text-lg md:text-xl text-gray-700/30 mb-16 md:mb-20" style={{ letterSpacing: '0.01em' }}>只需 2 分钟，测出你真实的互联网精神状态</p>
        <button
          onClick={onStartQuiz}
      ...
      {/* Footer */}
      <footer className="text-center py-16 sm:py-20 text-sm text-gray-700/20 relative z-10" style={{ letterSpacing: '0.04em' }}>
